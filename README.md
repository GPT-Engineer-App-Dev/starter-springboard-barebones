...
**Project**: starter-springboard-barebones 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/starter-springboard-barebones.git
cd starter-springboard-barebones
npm i
